 Submission for the Kaggle classification competition for the titanic dataset: This folder contains the submission attempt dataset and notebook code (without hyperparameter tuning).
